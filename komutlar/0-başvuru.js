...
.setColor('GREEN')
.setDescription('Başvurunuz Gönderildi En Kısa Sürede <#779331417838452756> Kanalından Cevap Vereceğiz!')
...
client.channels.cache.get('779331417838452756').send(embed2); 
};
exports.conf = {
    enabled: true,
    guildOnly: true,
